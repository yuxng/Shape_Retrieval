...
MODEL_FILE = 'models/GoogleNet/test_contrastive_embed64.prototxt'
CAFFE_MODEL = 'output/googlenet_contrastive_embed64_iter_47.caffemodel'
...
for batch_id in range(num_batches):
    batch = net.forward()
    fc = net.blobs['fc8_custom_normalized'].data.copy()
