...
MODEL_FILE = 'models/GoogleNet/test_liftedstructsim_softmax_embed64.prototxt'
CAFFE_MODEL = 'output/googlenet_liftedstructsim_softmax_embed64_iter_55.caffemodel'
